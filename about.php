            ...
            <div class='content'>
                ...
                if (isset($_POST['verzending'])) {
                    ...
                    <p>
                        ...
                        een directe concurrent van het grote bedrijf Netflix. Als studenten wilden wij deze pagina zo aantrekkelijk
                        ...
                        spoelen.
                        Ook heeft de gebruiker geen last van reclameblokken, wat wel het geval zou zijn bij TV-zenders. <br/><br/>
                        Als doelgroep hebben wij gekozen voor mensen die van oorlogsfilms houden. Hierbij is tijdens het maken
                        en het ontwerpen van de webpagina rekening mee gehouden. Beiden zijn wij erg gefascineerd door
                        oorlogsfilms.
